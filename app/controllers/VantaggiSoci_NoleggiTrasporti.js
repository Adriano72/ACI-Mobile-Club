...
function openWin() {
    ...
    Alloy.Collections.noleggiTrasporti.fetchIfChanged(function(err, cached) {
        updateUI();
...
function dettaglioConvenzione(e) {
	var selectedConv = Alloy.Collections.noleggiTrasporti.getByCid(e.rowData.modelId);

	var dettConvenzione = Alloy.createController('VantaggiSoci_Dettaglio_Convenzione', {data: selectedConv, headerImg:"logoNoleggiTrasporti.png"}).getView();
...
function mostraMappa() {
	...
	var mapWin = Alloy.createController('mapView', {
		collection : Alloy.Collections.noleggiTrasporti.toJSON(),
		pin : "pin_NoleggiTrasporti.png",
		titolo: (OS_ANDROID)?"Noleggi & Trasporti":$.titleControl.backgroundImage,
		homeIcon: "menulaterale_mobilita_blu.png"
